...
function sheryAnimation() {
  Shery.imageEffect(".image-div", {
    ...
    config: {
      ...
      aspect: { value: 0.7833148284490983 },
...
function textAnimation() {
  ...
  var text = document.querySelector(".footer-part1 h1")
  var text2 = document.querySelector(".footer-part1 h2")
  var textDiv = document.querySelector(".footer-part1")
  ...
  text2.textContent.split("").forEach(elem => {
    clutter2 +=  `<span>${elem}</span>`
  });
  text2.innerHTML = clutter2


  textDiv.addEventListener("mouseenter", function(){
    gsap.to(".footer-part1 h1 span", {
      opacity: 0,
      stagger: 0.05
    })
    gsap.to(".footer-part1 h2 span", {
      delay: 0.35,
      opacity: 1,
      stagger: 0.01
    })
    gsap.to(".footer-part1 svg", {
      x: 40,
      delay: 0.05
    })
  })
